                    ...
                    if self.variance_flag:
                        ...
                        if self.alarm_decision(True):
                            ...
                            if (area < area_1):
                                ...
                                print('Valve 1')
                            elif (area > area_1 and area < area_2):
                                #self.sendSerial.write(str.encode('b'))
                                print('Valve 1 and Valve 2')
                            elif (area > area_2 and area < area_3):
                                #self.sendSerial.write(str.encode('c'))
                                print('Valve 1 and Valve 2 and Valve 3')
                            elif (area > area_3 and area < area_4):
...
if __name__ == '__main__':
    ...
    cap = cv2.VideoCapture('C:\\Users\\nilen\\OneDrive\\Desktop\\JU project\\my_code\\multiple_flow_sprinkler\\test1.mp4')
