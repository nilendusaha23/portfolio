# -*- coding: utf-8 -*-
"""
Created on Mon Nov 23 00:42:58 2020

@author: Nilendu Saha

The code deals with the training and prediction of the Roll angle values using LSTM method. 
"""
...
# load the dataset
dataset = pandas.read_excel('roll.xlsx')
plt.plot(dataset)
plt.show()
print(dataset)
...
history = model.fit(trainX, trainY, epochs=100, batch_size=batch_size, verbose=1, shuffle=False, validation_data=(testX,testY))
#%%
...
## save to xlsx file
filepath = r'roll_pred_LSTM.xlsx'
df2.to_excel(filepath, index=False)
print("done")

#%% Predicting the future
x_input = numpy.array([0.017889962, 0.01776272, 0.017635924])
