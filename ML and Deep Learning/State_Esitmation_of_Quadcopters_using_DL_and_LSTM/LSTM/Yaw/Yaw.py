# -*- coding: utf-8 -*-
"""
Created on Mon Nov 23 01:40:31 2020

@author: Nilendu Saha

The code deals with the training and prediction of the Yaw angle values using LSTM method. 
"""
...
# load the dataset
dataset = pandas.read_excel('yaw.xlsx')
plt.plot(dataset)
plt.show()
print(dataset)
