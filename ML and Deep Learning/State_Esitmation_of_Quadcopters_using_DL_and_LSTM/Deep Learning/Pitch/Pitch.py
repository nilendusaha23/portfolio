# -*- coding: utf-8 -*-
"""
Created on Sat Dec  5 01:49:33 2020

@author: Nilendu Saha

The code deals with the training and prediction of the Pitch angle values using Deep Learning method. 
"""
...
#%% Load datasets
dataset = pandas.read_excel(r'pitch.xlsx')
plt.plot(dataset)
plt.show()
